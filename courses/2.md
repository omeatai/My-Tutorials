...
<details>
  <summary>69. Databases - Setting up MongoDB Atlas and Mongoose  </summary>
...
```jsbs
mongodb+srv://<username>:<password>@nasacluster.0p5vet9.mongodb.net/?retryWrites=true&w=majority
```

```jsbs

const { MongoClient, ServerApiVersion } = require('mongodb');
const uri = "mongodb+srv://<username>:<password>@nasacluster.0p5vet9.mongodb.net/?retryWrites=true&w=majority";
